...
export default function ScrollMorphHero() {
  ...
  const [morphValue, setMorphValue] = useState(0.01);
      ...
      <div className="flex h-full w-full flex-col items-center justify-center" style={{ perspective: '1000px' }}>
        ...
        <div className="absolute z-0 flex flex-col items-center justify-center text-center pointer-events-none top-1/2 -translate-y-1/2">
          ...
          <motion.p
            ...
            className="mt-4 text-xs font-bold tracking-[0.2em] text-white/40"
          >
            SCROLL TO EXPLORE
          </motion.p>
        </div>
        ...
        >
          ...
          <p className="text-sm md:text-base text-white/50 max-w-lg leading-relaxed">
            A private community of entrepreneurs who are already moving.<br className="hidden md:block" />
